...
public class SpringMybatisMapperRegistry extends MybatisMapperRegistry {

    private final Map<Class<?>, MybatisMapperProxyFactory<?>> knownMappers = new HashMap<>();
    private final MybatisConfiguration config;

    public SpringMybatisMapperRegistry(MybatisConfiguration config) {
        super(config);
        this.config = config;
    }
...
//                throw new BindingException("Type " + type + " is already known to the MapperRegistry.");
            ...
            try {
                ...
                knownMappers.put(type, new SpringMybatisMapperProxyFactory<>(type));
